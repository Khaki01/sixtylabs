...
//           <Link href="/">
//             <Button variant="outline" size="sm" className="font-mono uppercase tracking-wider bg-transparent mb-4">
//               <ArrowLeft className="w-4 h-4 mr-2" />
//               Back
//             </Button>
//           </Link>
//           <h1 className="font-mono text-3xl md:text-4xl font-bold tracking-tight">PROFILE</h1>
//         </div>
...
//             </Avatar>
//             <div>
//               <h2 className="font-mono text-xl font-bold uppercase tracking-wider">{user.name}</h2>
//               <p className="font-mono text-sm text-muted-foreground uppercase tracking-wider">User</p>
//             </div>
//           </div>
...
//               <div>
//                 <p className="font-mono text-xs uppercase tracking-wider text-muted-foreground">Member Since</p>
...
//             <Button variant="outline" className="w-full font-mono uppercase tracking-wider bg-transparent">
//               Edit Profile
//             </Button>
//             <Button variant="outline" className="w-full font-mono uppercase tracking-wider bg-transparent">
//               Sign Out
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="border-2 border-foreground bg-muted/30 p-6 space-y-6">
          <div className="flex items-center gap-4 pb-4 border-b-2 border-foreground">
            ...
            <div>
              <h2 className="font-mono text-xl font-bold uppercase tracking-wider">{user.username}</h2>
              <p className="font-mono text-sm text-muted-foreground uppercase tracking-wider">User</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 p-3 border-2 border-foreground bg-background">
              <User className="w-5 h-5" />
              <div>
                <p className="font-mono text-xs uppercase tracking-wider text-muted-foreground">Username</p>
