...
const AVAILABLE_EFFECTS = [
  ...
  { id: "drunk", name: "Drunk", number: "EE08" },
  { id: "eq", name: "EQ Filter", number: "EE09" },
  { id: "repeat", name: "Repeat", number: "EE10" },
];
    ...
    <div className="space-y-6">
      ...
      {enabledEffects.includes("repeat") && (
        <div className="border-2 border-foreground bg-muted/30 p-4 space-y-3 rounded-lg">
          ...
          <div className="space-y-2">
            <label className="font-mono text-xs uppercase tracking-wider">
              Repeat Factor: {effects.repeat.toFixed(1)}x
            </label>
            <Slider
              value={[effects.repeat]}
              onValueChange={([value]) =>
                setEffects({ ...effects, repeat: value })
              }
              min={1}
              max={8}
              step={0.1}
          ...
          <div className="space-y-2">
            <label className="font-mono text-xs uppercase tracking-wider">
              Cycle Size: {effects.repeatCycleSize}ms
            </label>
            <Slider
