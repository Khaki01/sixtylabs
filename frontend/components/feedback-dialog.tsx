...
export default function FeedbackDialog() {
  ...
  return (
    <div className="relative">
      <Button variant="outline" size="sm" onClick={() => setIsOpen(!isOpen)} className="font-mono bg-transparent">
            ...
            <FadeContent duration={200} initialOpacity={0}>
              <div className="border-2 border-foreground bg-background shadow-lg w-full max-w-md">
                ...
                <div className="border-b-2 border-foreground p-4 flex items-center justify-between">
                  <h3 className="font-mono text-sm uppercase tracking-wider font-bold">Feedback</h3>
                ...
                <form onSubmit={handleSubmit} className="p-4 space-y-4">
                  <div className="space-y-2">
                    ...
                    <Select
                      value={feedbackType}
                      onValueChange={(value: "bug" | "feedback" | "feature") => setFeedbackType(value)}
                    >
                      <SelectTrigger className="w-full font-mono uppercase tracking-wider border-2 border-foreground">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="bug" className="font-mono uppercase tracking-wider">
                          Bug Report
                        </SelectItem>
                        <SelectItem value="feedback" className="font-mono uppercase tracking-wider">
                          General Feedback
                        </SelectItem>
                        <SelectItem value="feature" className="font-mono uppercase tracking-wider">
                          Feature Request
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  ...
                  {/* Message */}
                  <div className="space-y-2">
                    <label className="font-mono text-xs uppercase tracking-wider">Message</label>
                    <textarea
                      value={message}
